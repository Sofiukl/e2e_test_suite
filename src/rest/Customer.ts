...
export  class Customer {
	...
	public create() : Promise<any>  {
		...
		return new Promise( (resolve) => {
			...
			//save to image
			ExcelUtils.getInstance().addHeading("Create Customer Request")
			
			ExcelUtils.getInstance().addText(`Creating Customer using REST API :
			"C0${this._customerCode}" : Customer Code
			"C0${this._customerCode}-7" : Cash Balance Account
			"C0${this._customerCode}-8" : Credit Balance Account
...
return `{
	"requestDataMap": {
		...
		"addresses": [{
				...
				"building": "", 
				"addressOwnerName1": "AAA 113/1 AAAA 5 ",
				"city": "",
				"street": "",
