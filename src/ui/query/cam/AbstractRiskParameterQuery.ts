...
export abstract class AbstractRiskParameterQuery extends BaseUIOperations {
    ...
    static ResultColumns = ResultColumns
        ...
        static AccountClass = AccountClass;
        static BalancePl = BalancePl;
        static DaysOfCall = DaysOfCall;
...
if(this._accountClass!=undefined){
  fields.push({ 'type' : 'text' , 'selector' : 'select[name="accountClass"]' , value : this._accountClass});
}
...
if(this._daysOfCall!=undefined){
  fields.push({ 'type' : 'text' , 'selector' : 'select[name="daysOfCall"]' , value : this._daysOfCall});
}
...
if(this._action!=undefined){
  fields.push({ 'type' : 'text' , 'selector' : 'select[name="action"]' , value : this._action});
}
