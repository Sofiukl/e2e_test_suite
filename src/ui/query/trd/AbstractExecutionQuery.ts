  ...
  */
  ...
  protected fetchFields(): any[] {
    ...
    if (this._executionStatus != undefined) {
      fields.push({ 'type': 'text', 'selector': 'select[name="executionStatus"]', value: this._executionStatus });
    }
    ...
    if (this._notificationStatus != undefined) {
      fields.push({ 'type': 'text', 'selector': 'select[name="notificationStatus"]', value: this._notificationStatus });
    }
