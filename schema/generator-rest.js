...
function generateRestAPI(path, fileName){
        ...
        var elements = requestObject.requestCriteriaMap
...
generateRestAPI("schema/rest/query/cam","QueryWithdrawalLimit.json")

//http://10.50.2.170/igv-rest/cam/withdrawallimit/1/query
